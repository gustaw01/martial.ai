...
## **Użyte technologie**
![Schemat działania martial.AI](docs/rozwiazanie.png "Schemat działania martial.AI")
* **Python**
...
![Schemat działania martial.AI](docs/proces.drawio.png "Schemat działania martial.AI")
